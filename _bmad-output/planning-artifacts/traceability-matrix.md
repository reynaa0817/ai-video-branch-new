...
| G0-2 全栈 P0 | Story 1.1 done | `reports/baseline/BASE-002/`：Web/媒体、Temporal schema+SDK、Kafka RF3 leader fault、Redis/MinIO/Nacos 已有；rebalance、K8s/CSI、升级/DR 和 internal-prod 仍待完成 | Architecture/SRE | Open |
