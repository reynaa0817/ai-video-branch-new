...
| G0-2 全栈 P0 | Story 1.1 done | `reports/baseline/BASE-002/` 与 `reports/dr/NFR-DR-001/`：全栈兼容、升降级、恢复及四类 provider 前置 fail-closed 均通过；稳定 CI artifact ID 仍待首次远端 workflow | Architecture/SRE | Open |
