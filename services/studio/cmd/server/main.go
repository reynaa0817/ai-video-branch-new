...
import (
	...
	storyprobe "github.com/frochyzhang/ai-video/services/studio/internal/probe"
)
...
func main() {
	...
	switch mode {
	case "record-probe", "inspect-roundtrip", "advance-platform-state", "inspect-platform-state":
